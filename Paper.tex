...
{\centering \includegraphics[width=\linewidth]{Paper_files/figure-latex/main-series-1} 
...
\begin{table}[H]
\centering
\caption{\label{tab:model-comparison}Final model comparison. Manual residual AIC is on the transformed residual scale; auto.arima uses untransformed detrended GSAx with the same lagged predictors.}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
...
\midrule
Blackwood & $R_a^2=0.0083$; $p_F=0.1182$ & ARIMA(0,0,0); AIC 1630.45 & ARIMA(0,1,1); AIC 1632 & ARIMA(0,0,0); AIC 967.98\\
Shesterkin & $R_a^2=0.0324$; $p_F=0.0038$ & ARIMA(0,0,0); AIC 1889.83 & ARIMA(0,1,1); AIC 1891.75 & ARIMA(0,0,0); AIC 962.54\\
\bottomrule
\end{tabular}}
\end{table}
...
{\centering \includegraphics[width=\linewidth]{Paper_files/figure-latex/residual-diagnostics-1} 
...
{\centering \includegraphics[width=\linewidth]{Paper_files/figure-latex/forecast-plot-1} 
...
The final analysis files are \texttt{data/blackwood\_gbgs.csv} and \texttt{data/shesterkin\_gbgs.csv} in this STA 209 repository (\citeproc{ref-sta209data}{Saijo 2026b}), built from the \texttt{rentosrink} game-by-game pipeline and expected-goals model (\citeproc{ref-rentosrink}{Saijo 2026a}). The main columns are game identifiers, team labels, \texttt{sv\_pct\_ev}, \texttt{gsax\_ev}, \texttt{xga\_ev}, \texttt{xgf\_ev}, and \texttt{team\_xg\_pct\_ev}. I kept regular-season even-strength games and matched both goalies to the first 285 career games in the available files.
...
{\centering \includegraphics[width=\linewidth]{Paper_files/figure-latex/periodogram-plot-1} 
...
{\centering \includegraphics[width=\linewidth]{Paper_files/figure-latex/ccf-plot-1} 
...
{\centering \includegraphics[width=\linewidth]{Paper_files/figure-latex/scatter-blackwood-sv-1} 
...
{\centering \includegraphics[width=\linewidth]{Paper_files/figure-latex/scatter-blackwood-xgf-1} 
...
{\centering \includegraphics[width=\linewidth]{Paper_files/figure-latex/scatter-shesterkin-sv-1} 
...
{\centering \includegraphics[width=\linewidth]{Paper_files/figure-latex/scatter-shesterkin-xgf-1} 
...
{\centering \includegraphics[width=\linewidth]{Paper_files/figure-latex/acf-pacf-comparison-1} 
...
\begin{table}[H]
\centering
\caption{\label{tab:auto-table}auto.arima comparison on untransformed detrended GSAx with selected lagged predictors.}
\centering
\resizebox{\ifdim\width>\linewidth\linewidth\else\width\fi}{!}{
\fontsize{6.8}{8.8}\selectfont
...
\midrule
Blackwood & $\tilde{S}_{t-4},\tilde{X}_{t-8}$ & ARIMA(0,0,0) & 1.9007 & 967.98 & 978.85\\
Shesterkin & $\tilde{S}_{t-2},\tilde{X}_{t-4}$ & ARIMA(0,0,0) & 1.7742 & 962.54 & 973.46\\
\bottomrule
\end{tabular}}
\end{table}

Table \ref{tab:auto-table} gives the automated comparison requested in the assignment. \texttt{auto.arima()} also selects ARIMA(0,0,0) with the lagged predictors included as \texttt{xreg}, which supports the manual conclusion that the residual dependence structure is already mostly explained by the regression-and-white-noise model.
