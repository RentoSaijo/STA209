...
with_family({
  plot(soi, main = 'Southern Oscillation Index over 453 Months', xlab = 'Time (year)', ylab = 'Southern Oscillation Index')
  par(new = TRUE); plot(m1$fitted, type = 'l', lwd = 2, lty = 2, col = 2, main = '', xlab = '', ylab = '', xaxt = 'n', yaxt = 'n')
  par(new = TRUE); plot(m2$fitted, type = 'l', lwd = 2, lty = 2, col = 3, main = '', xlab = '', ylab = '', xaxt = 'n', yaxt = 'n')
  par(new = TRUE); plot(m3$fitted, type = 'l', lwd = 2, lty = 2, col = 4, main = '', xlab = '', ylab = '', xaxt = 'n', yaxt = 'n')
