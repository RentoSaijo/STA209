...
\begin{center}\includegraphics[width=\linewidth]{Homework7_files/figure-latex/p1-raw-plots-blackwood-1} \end{center}
...
\begin{center}\includegraphics[width=\linewidth]{Homework7_files/figure-latex/p1-raw-plots-shesterkin-1} \end{center}
...
\begin{center}\includegraphics[width=\linewidth]{Homework7_files/figure-latex/p1-periodogram-blackwood-1} \end{center}
...
\begin{center}\includegraphics[width=\linewidth]{Homework7_files/figure-latex/p1-periodogram-shesterkin-1} \end{center}
...
\begin{center}\includegraphics[width=\linewidth]{Homework7_files/figure-latex/p1-ccf-blackwood-1} \end{center}
...
\begin{center}\includegraphics[width=\linewidth]{Homework7_files/figure-latex/p1-ccf-shesterkin-1} \end{center}
...
\begin{center}\includegraphics[width=\linewidth]{Homework7_files/figure-latex/p1-scatter-blackwood-sv-1} \end{center}
...
\begin{center}\includegraphics[width=\linewidth]{Homework7_files/figure-latex/p1-scatter-blackwood-xgf-1} \end{center}
...
\begin{center}\includegraphics[width=\linewidth]{Homework7_files/figure-latex/p1-scatter-shesterkin-sv-1} \end{center}
...
\begin{center}\includegraphics[width=\linewidth]{Homework7_files/figure-latex/p1-scatter-shesterkin-xgf-1} \end{center}
...
\begin{center}\includegraphics[width=\linewidth]{Homework7_files/figure-latex/p1-transformation-plots-1} \end{center}
...
\begin{center}\includegraphics[width=\linewidth]{Homework7_files/figure-latex/p2-residual-plots-1} \end{center}
...
\begin{center}\includegraphics[width=\linewidth]{Homework7_files/figure-latex/p2-acf-pacf-1} \end{center}
...
Finally, I apply \texttt{forecast::auto.arima()} to the raw response \(G_t\) for each goalie while including the raw predictor series \(S_t\) and \(X_t\) as supplementary regressors through \texttt{xreg}. The time index is still career game number with frequency \(1\).

\begin{center}
\small
\begin{table}[H]

\caption{\label{tab:p2-auto-table}auto.arima results for raw GSAx with raw save percentage and team xGF\% predictors}
\centering
\begin{tabular}[t]{ccccc}
\toprule
Goalie & ARIMA Order & $\hat{\sigma}^2$ & AIC & BIC\\
\midrule
Blackwood & (0,1,1) & 0.6856 & 706.5784 & 721.1743\\
Shesterkin & (0,1,1) & 0.4666 & 598.0283 & 612.6242\\
\bottomrule
\end{tabular}
\end{table}
\normalsize
...
For Blackwood, \texttt{auto.arima()} selects (0,1,1) for raw \(G_t\) using raw \(S_t\) and \(X_t\) as regressors. The fitted equation is
\[
G_t=G_{t-1}+14.3200(S_t-S_{t-1})-0.0040(X_t-X_{t-1})+W_t-0.9700W_{t-1}.
\]
For Shesterkin, \texttt{auto.arima()} selects (0,1,1) for raw \(G_t\) using raw \(S_t\) and \(X_t\) as regressors. The fitted equation is
\[
